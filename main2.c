...
/**/
/*
	lwt_t chd1 = lwt_create(my_foo,1,LWT_JOIN,NULL);
	lwt_t chd2 = lwt_create(my_foo,2,LWT_JOIN,NULL);
	lwt_t chd3 = lwt_create(my_foo,3,LWT_JOIN,NULL);
